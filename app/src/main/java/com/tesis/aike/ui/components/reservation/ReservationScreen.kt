...
@Composable
fun ReservationScreen(rootNavController: NavController, username: String) {
...
fun ReservationScreenPreview() {
    AikeTheme {
        ReservationScreen(rootNavController = rememberNavController(), username = "UsuarioPreview")
    }
}